...
namespace OutbreakSurvivor {
	...
	class Tuberculosis : Disease {
	    private Random random = new Random();
		public override string Name {
			get { return Resources.DiseaseTuberculosisName; }
		}

		public override string Description {
			get { return Resources.DiseaseTuberculosisDescription + " [" + Resources.DiseaseRadiusText + "=" + Radius + "]"; }
		}
